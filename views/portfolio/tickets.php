<div class="portfolio-content">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <h2>Take a ticket to travel the world.</h2>
        </div>
    </div>

    <div class="row">
        <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
            <p>This project was created from a prompt to create a set of unified cards containing only typography &mdash; I wanted to interprete cards into something that is meant to be more tactile. Tickets, have a strong sense of purpose and are an important object that can signify the quality of the experience a person has signed up and paid to do.</p>
        </div>
        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 skils-list">
            <h2>Tools</h2>
            <ul>
                <li>Illustrator</li>
                <li>InDesign</li>
